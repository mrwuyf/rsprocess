...
# 设置文件夹路径
image_folder = r"E:\liutian\wetlanddataset\images"
mask_folder = r"E:\liutian\wetlanddataset\masks"
...
for mask_file in mask_files:
    ...
    if is_all_zero_tif(mask_path):
        ...
        if os.path.exists(image_path):
            ...
            print(f"{mask_file} 全为0，对应的 {mask_file} 和 {mask_file} 已删除。")
